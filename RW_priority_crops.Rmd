...
* Survey results can be harmonized and adjusted relative to a given baseline (in this case the ongoing RwaSIS survey, `scode = base`) for the purpose of SAE as well as national-level reporting of crop distributions, which makes disparate survey data sources more comparable and inclusive. 
