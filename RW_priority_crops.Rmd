...
The `scode` survey designations of either `base` or `other` are important for adjusting/weighting the SAEs that are subsequently calculated as fixed effects relative to the currently ongoing RwaSIS cropland survey. 
