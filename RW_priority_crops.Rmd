...
3. The [CNLS](https://cropnuts.com/) soil survey of Rwanda's croplands, designated as `s2`, which is openly accessible at: [OSF](). There are 602 observations in this survey in which at least one of the priority crops was present. These were extracted from the crop type descriptions from the soil survey meta-data.
