...
author: M.G. Walsh, R. Manners and J. Rutebuka
...
```{r}
# Package names
packages <- c("downloader", "rgdal", "sp", "raster", "leaflet", "DT", "htmlwidgets", "devtools", "caret", "caretEnsemble", "mgcv", "MASS", "glmnet", "randomForest", "xgboost", "nnet", "dplyr", "doParallel", "dismo", "arm")
