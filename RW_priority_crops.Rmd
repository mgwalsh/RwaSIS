...
# Calculate total number of survey labels and center coordinates
...
# also see [square buffer](https://www.neonscience.org/resources/learning-hub/tutorials/field-data-polygons-centroids)
```
