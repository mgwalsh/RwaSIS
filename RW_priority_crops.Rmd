...
* This notebook produces precise and accurate spatial predictions of the observed occurrence (presence / absence) of assembled bean occurrence data in Rwanda based on a completely reproducible, standard ensemble machine learning workflow.
