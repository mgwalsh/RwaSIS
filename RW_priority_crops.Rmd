...
The table of observations and the relevant SAE `bean` estimates by `GID` are generated in the chunk below based on the `m2` SAE model results. These should be consulted and updated for planning additional survey activities and/or experiments that require crop distribution and geographical guidance data. Again, the estimates can be flexibly extended to include other crop distributions.
