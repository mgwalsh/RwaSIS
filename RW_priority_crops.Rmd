...
The `scode` designations of `base` or `other` are important for adjusting/weighting the SAEs that are calculated as fixed effects in this notebook relative to the currently ongoing RwaSIS cropland survey and its associated planning procedures for management response and cropland monitoring trials. 
