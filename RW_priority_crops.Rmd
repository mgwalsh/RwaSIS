...
2. The [CIALCA Farm Heterogeneity Survey of Rwanda, (2018)](https://cialca.shinyapps.io/cialca_base_2files/) survey desinated as `s1`. There are 3,570 georeferenced observations in this survey. Note that the spatial coordinates for this survey are slightly offset to the GPS locations of the surveyed households rather than the locations of actual fields.
