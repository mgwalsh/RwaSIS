...
* Survey results can be readily harmonized and adjusted relative to a given baseline (in this case the ongoing RwaSIS survey, `scode`) for the purpose of SAE as well as national-level reporting of crop distributions, which makes disparate survey data sources more comparable and inclusive. 
