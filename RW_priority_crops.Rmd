...
RAB's 6 priority crop observations were assembled from 4 surveys:

1. The currently ongoing RwaSIS survey designated as `base` (see the raw data at: [Kobo]())
2. 
3.
4.
