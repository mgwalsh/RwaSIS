...
The `scode` designations of either `base` or `other` are important for adjusting/weighting the SAEs that are subsequently calculated as auxiliary fixed effects relative to the currently ongoing RwaSIS cropland survey, and its associated planning procedures for management response and cropland monitoring trials. 
