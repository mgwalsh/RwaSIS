...
* We recommend a standard small equal area (such as the `GID`) over admistrative regions for SAEs. The reasons for this are both operational and conceptual. Operationally, `GID` can be navigated to easily just using a GPS. Conceptionally, `GID`, unlike administrative units, will not change over time ... barring meteor impacts.
