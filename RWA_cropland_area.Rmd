...
Most impotantly I hope that GeoSurvey data and their analyses might provide you with a backend foundation for reliablely evaluating land cover and land use changes in your own ROIs. I'll update the introductory examples in this notebook as additional ground data for the occurrence of e.g., specific crops, cropping systems and soil / site surveys become available for Rwanda over the coming year via the ongoing [RwaSIS project](https://minagri.prod.risa.rw/updates/news-details/rwanda-launches-soil-information-service-project-to-improve-agriculture-productivity). Any questions or comments about this notebook are most welcome via [AFSIS](mailto:mgw.africasoils.info).
