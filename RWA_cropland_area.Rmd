...
The next chunk fits 4 additional models that use the that use all of gridded data with 10-fold cross-validation. You can learn more about how these work from the following links at: 
...
This next chunk fits the model ensemble with the `glmStepAIC` function from the `MASS` library using the **validation dataframe**. You could explore other options here, but I think that this provides a reasonable combination and weighting of the 6 models that were produced in the calibration / training steps.
