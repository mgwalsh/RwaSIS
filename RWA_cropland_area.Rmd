...
# Project cropland mask to EPSG:3857
...
* The approach can be flexibly extended to map other land cover variables (e.g., the occurrence of buildings, forest cover and built-up infrastructure, among others). It can also be rapidly extended to cover new geographies and ROIs.
* 
