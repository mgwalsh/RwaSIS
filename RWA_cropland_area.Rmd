...
* This notebook produces highly accurate (>95%) spatial predictions of the observed occurence (presence / absence) of croplands in Rwanda based on an ensemble machine learning approach.
* The approach can be flexibly extended to map other land cover characteristics (e.g., building, dense woody vegetation cover and built-up infrastructure presence / absence, among others).
* 
