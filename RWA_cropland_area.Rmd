...
This next chunk assembles the various GeoSurvey observations for Rwanda (*n* = 23,776, 6.25 ha quadrats).  It also calculates building count (`bcount`) as well as cropland grid count data (`cgrid`) in the associated geojson fields in this GeoSurvey. I shall use the resulting `ccount` variable for small cropland area estimation later on in the notebook.
