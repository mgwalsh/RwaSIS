...
```{r}
# Package names
packages <- c("osfr", "downloader", "jsonlite", "rgdal", "sp", "raster", "leaflet", "DT", "htmlwidgets", "caret", "caretEnsemble", "mgcv", "MASS", "randomForest", "xgboost", "nnet", "klaR", "dplyr", "doParallel", "dismo", "arm")
...
```{r geosurvey_examples, echo=FALSE, fig.align="center", fig.cap="Examples of archetypal GeoSurvey quadrats observed over Rwanda.", out.width = '95%'}
...
```{r, echo = FALSE, fig.align = "center", fig.height = 5, fig.width = 5, fig.cap = "Cropland classification ROC curve for the validation set."}
...
```{r, echo = FALSE, fig.align="center", fig.cap = "Predicted building counts (no. buildings ha^-1^) relative to the main electrical grid in Rwanda (2020).", out.width = '90%'}
knitr::include_graphics("./RW_GS20/BD_grid.png")
```

## Woody vegetation

In Rwanda dense woody vegetation (> 60%) generally occurs only in protected areas such as national parks and/or nature reserves.
...
```{r, echo = FALSE, fig.align="center", fig.cap = "AfSIS GeoSurvey land cover classification and area estimates for Rwanda (LCC, 2020).", out.width = '95%'}
knitr::include_graphics("./RW_GS20/LCC.png")
```

## Conservation structures

The map below shows the areas where soil conservation structures are predicted to occur based on the current GeoSurvey observations of terraces and other structures such as contour bunds. The map was derived using a combination of geospatial variables using the ensemble prediction approaches described in the main notebook text.
...
You can also check out related notebooks on Github for additional context and content including:
