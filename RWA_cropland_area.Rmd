...
* The model outputs can be used to improve the precision and accuracy of small area estimates, and depending on the availability of properly time-stamped GeoSurveys, also for cropland area monitoring and change detection workflows, operationally and at low cost.
