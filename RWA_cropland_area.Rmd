...
stll <- projectRaster(1-st, crs="+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")

# Set color pallette
pal <- colorNumeric("Greens", domain = 0:1, na.color = "transparent")
...
w <- leaflet() %>% 
  ...
  addLegend(pal = pal, values = values(stll), title = "Cropland probability")
w ## plot widget
```
