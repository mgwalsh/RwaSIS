...
While the national-level estimate of cropland proportion is not affected much, its precision as measured by the residual deviance comparison between the two models is.
