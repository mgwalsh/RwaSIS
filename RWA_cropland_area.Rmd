...
The processed Rwanda raster data (`grids` in the chunk above) were derived from and reprojected from their primary open sources. You can also download the entire `grids` raster stack directly at [RwaSIS grids](https://osf.io/hp6v7/). The short descriptions of the included features, and their sources are provided in the table immediately below.
...
The main notion here is that the occurrence and distribution of croplands must be associated with the distribution of humans and their infrastructure, but also constrained by environmental factors such as climate, relief, parent materials and soils. All of these change over time and space and should be, but are currently not, monitored systematically.
