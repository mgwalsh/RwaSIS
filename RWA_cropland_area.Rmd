...
The slightly lower deviance of the `m2` model for area predictions indicates that it maybe preferable. Note however that the difference is small and is not validated. So, I would still go with the `m1` estimate in this particular case based on the data here and the [parsimony principle](https://en.wikipedia.org/wiki/Occam%27s_razor).
