...
This assembles the GeoSurvey observations from *n* = 23,776 (250 × 250 m) [quadrats](https://en.wikipedia.org/wiki/Quadrat). It also calculates building counts and cropland grid counts from the associated point location geojson fields (`bloc` & `cgrid`) of this GeoSurvey. I shall use the resulting cropland grid count variable (`ccount`) for small area estimation later on in the notebook.
