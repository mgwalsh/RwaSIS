...
```{r geosurvey_examples, echo=FALSE, fig.align="center", fig.cap="Examples of archetypal GeoSurvey quadrats observed over Rwanda.", out.width = '90%', }
...
* The approach can be flexibly extended to map other land cover variables (e.g., the occurrence of buildings, dense woody vegetation cover and built-up infrastructure, among others). It can also be rapidly extended to cover new geographies and ROIs.
* 
