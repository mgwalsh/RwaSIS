...
* The model outputs can be used to improve the precision of small area estimates, but depending on the availability of properly time-stamped GeoSurveys, also for cropland area monitoring and change detection workflows, operationally and at low cost.
