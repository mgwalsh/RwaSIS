...
While the national-level estimate of cropland proportion (viz `m0`) is not affected much, its precision as measured by the residual deviance comparison between the two models is. The next chunk calculates small area estimates for the 30 districts of Rwanda.
