...
The main notion here is that the occurrence and distribution of croplands must be associated with the distribution of humans and their infrastructure, but also constrained/facilitated by environmental factors such as climate, relief, parent materials and soils. Note that all of these change over time and space and should be, but are currently not, adequately monitored in Africa.
