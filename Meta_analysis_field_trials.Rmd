...
* In the OAF trials presented, the application of lime showed only small positive intervention effects on crop yields (~350 kg ha^-1^ per metric ton ha^-1^ of lime added), which were observed over 8 cropping seasons relative to their respective comparator yields. The fairly low average lime application rates (see Figure 2) in these trials may not have been sufficient to overcome the exchangeable (reserve) acidity constraints nor to effectively alter soil pH. However, testing for specific lime dose-response relationships would require additional and more systematically collected intervention and comparator data.
