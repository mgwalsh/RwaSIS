...
* The simple question: "By how much aglime applications can improve maize and bean crop yields on the acid soils in Rwanda?", cannot be answered in this notebook. At present we can infer at present is that there are modest improvements in some of the surveyed cells. What we do not know is if these local improvements warrant the lime application costs to farmers in those places.
