...
We can also plot the model fit to the trial data with the following chunk. This demonstrates that a fairly simple PICO-based multilevel model can explain a substantial amount of the variation in a fairly complex dataset. However, also note that this is not intended as a prediction of what out-of-sample trials might look like ... it just shows an unvalidated fit to the data.
