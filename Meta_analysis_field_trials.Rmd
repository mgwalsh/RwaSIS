...
* The associated analyses run fast (< 1 min) on a normal, 8 core, 16 Gb memory computer and could be further automated for the purpose of EDAs, outlier screening, monitoring and data modeling as new survey and trial data become available in Rwanda or elsewhere. 
