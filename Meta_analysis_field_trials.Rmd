...
* In the two studies presented the application of lime showed only modest positive effects on either maize or bean crop yields that were observed over a two year period vis-à-vis their respective control yields. Beans tended to be slightly more responsive to lime applications than maize.
