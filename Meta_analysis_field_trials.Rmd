...
* Specify lime provenance data (see e.g., [Rwanda aglime sources]()). Lime sources in Rwanda and elsewhere are quite variable in terms of their calcium cabonate equivalents (CCE), Ca/Mg ratios and estimated extractable source reserves.
