...
The main question that is posed here is: *"By how much could crop yields be increased with aglime applications?"* The relevant PICO definitions for addressing this question are:

* P - on-farm food crop yield trials conducted in Rwanda
...
```{r, echo = FALSE, fig.align = 'center', fig.show='hold', out.width="75%", fig.cap = "Figure 2: Lime application rate effects on mean yield differences in Rwanda based on a site-level mixed-effects model."}
